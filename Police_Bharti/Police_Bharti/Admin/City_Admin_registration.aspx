<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin_Master.Master" AutoEventWireup="true" CodeBehind="City_Admin_registration.aspx.cs" Inherits="Police_Bharti.Admin.City_Admin_registration" %>
                    ...
                    <WizardSteps>
                        <asp:WizardStep runat="server" Title="Registration">
                            ...
                            <table style="font-size:100%;width:502px;">
                                    <tr>
                                        <td align="center" colspan="2"><h4>City Admin Registration</h4></td>
                                    </tr>
                                    <tr>
