...
{
    public partial class Plan_Gramin_Event : System.Web.UI.Page
    {
        ...
        protected void btnupdate_Click(object sender, EventArgs e)
        {
            ...
            MySqlCommand cmd = new MySqlCommand("Update pb_gramin_event_plan set start_date=@a, end_date=@b where id=" + id, conn);
