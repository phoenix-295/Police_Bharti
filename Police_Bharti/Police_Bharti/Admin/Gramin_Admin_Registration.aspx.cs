...
{
    public partial class Gramin_Admin_Registration : System.Web.UI.Page
    {
        ...
        protected void areg()
        {
            try
            {
                ...
                MySqlCommand cmd = new MySqlCommand("INSERT into pb_gramin_admin (police_id,buckle_no,name,birth_date,joining_date,address) values(@a,@b,@c,@d,@e,@f)", ocon);
