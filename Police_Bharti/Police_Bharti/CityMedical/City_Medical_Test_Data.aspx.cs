...
{
    public partial class City_Medical_Test_Data : System.Web.UI.Page
    {
        ...
        protected void c_hide()
        {
            ...
            MySqlCommand cmd = new MySqlCommand("select end_date from pb_city_event_plan where id=3", conn);
        ...
        protected void btnshow_Click(object sender, EventArgs e)
        {
            ...
            MySqlCommand command = new MySqlCommand("update pb_city_data set cm_submit=@a ", conn);
