<%@ Page Title="" Language="C#" MasterPageFile="~/City_Physical/City_Physical.Master" AutoEventWireup="true" CodeBehind="City_Physical_Ground_Edit.aspx.cs" Inherits="Police_Bharti.City_Physical.City_Physical_Ground_Edit" %>
                        ...
                        <td style="vertical-align:top">
                            <table class="w-100">
                                <tr>
                                    ...
                                    <td>
                                        <asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="True" CssClass="form-control" Width="290px" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged">
                                        </asp:DropDownList>
                                    </td>
                                </tr>
                            </table>
                    ...
                    <tr>
                        <td style="vertical-align:top">
                            <table class="w-100">
                                ...
                                <tr>
                                    <td style="width: 150px; height: 30px;"><h4>Comment: </h4></td>
                                    <td style="height: 30px">
                                        <table class="w-100">
                                            <tr>
                                                <td style="width: 320px">
                                                    <asp:TextBox ID="txtcomment" runat="server" CssClass="form-control" placeholder="Enter your comment here!" TextMode="MultiLine" Width="290px"></asp:TextBox>
                                                </td>
                                                <td>
                                                    <asp:RequiredFieldValidator ID="rfc" runat="server" ControlToValidate="txtcomment" Display="Dynamic" ErrorMessage="Comment is required" SetFocusOnError="True" ValidationGroup="1">*</asp:RequiredFieldValidator>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                        ...
                                        <table class="w-100">
                                            <tr>
                                                <td style="width: 154px">
                                                    <asp:Button ID="btnsub" runat="server" CssClass="btn btn-primary" TabIndex="6" Text="Update" ValidationGroup="1" OnClick="btnsub_Click" style="width: 91px" />
                                                </td>
                                                <td>
                                                    <asp:Button CssClass="btn btn-danger" ID="btnabs" runat="server" Text="Absent" />
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
